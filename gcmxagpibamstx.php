...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=347059');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "347059");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "680b7056bda37a7d8c8779384dd82d0b695971ab0459fa527734b8b5a3c2409c");
define('CREATED_TIMESTAMP', "1609993852");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor347059');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor347059');
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "lamgiauk.xyz",
));
